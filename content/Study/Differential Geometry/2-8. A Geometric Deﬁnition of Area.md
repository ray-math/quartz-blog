이 절의 목표는 [[2-5. The First Fundamental Form; Area|2-5.]]절에서 소개된 면적 공식에 대한 기하학적 정당성을 부여하는 것이다. 이는 곡면 위의 영역을 평면 영역들의 합으로 근사하고, 그 극한을 통해 면적을 정의한 뒤, 이 정의가 적분 공식과 일치함을 보이는 방식으로 이루어진다.
