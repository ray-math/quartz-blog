...
> [!NOTE]
> https://plus.maths.org/content/happy-women-maths-day-2025
>
> 오늘을 기념하여, 수학 연구에서 뛰어난 업적을 이룬 동시에 대중과의 소통에도 탁월한 능력을 보여준 네 명의 여성 수학자들과의 인터뷰를 다시 소개합니다.

![Maryam Mirzakhani](https://plus.maths.org/content/sites/default/files/styles/small_square/public/2025-05/Maryam.jpg?h=533f8a9f&itok=Xcjt-ANM)

5월 12일은 [세계 여성 수학인의 날(International Women in Maths Day)](https://may12.womeninmaths.org/)입니다! 이 날의 목적은 전 세계 여성 수학자들에게 영감을 주고 그들의 업적을 기념하는 것입니다. 이 날짜는 이란 출신 수학자 마리암 미르자카니(Maryam Mirzakhani)의 생일에 맞춰 선정되었습니다. 그녀는 수학계에서 가장 권위 있는 상 중 하나인 필즈상(Fields Medal)을 받은 최초의 여성이었지만, 안타깝게도 40세의 나이에 세상을 떠났습니다.

> 필즈상은 '수학계의 노벨상'으로 불리며, 4년마다 40세 미만의 수학자에게 수여되는 최고의 영예입니다. 이 상이 40세 미만으로 제한되는 이유는 젊은 수학자들의 창의적 업적을 장려하기 위함입니다. 미르자카니는 2014년 쌍곡기하학(hyperbolic geometry)과 리만 곡면(Riemann surfaces)의 복잡한 구조에 대한 혁신적인 연구로 이 상을 받았습니다. 그녀의 업적은 기하학, 위상수학, 동역학계 이론을 아우르는 깊이 있는 통찰을 담고 있었습니다. 2017년 유방암으로 세상을 떠났을 때, 전 세계 수학계는 뛰어난 재능과 헌신적인 연구자를 잃은 슬픔에 잠겼습니다.
...
우리는 또한 줄리아와 함께 [일련의 영상과 인터랙티브 콘텐츠](https://plus.maths.org/content/contagious-maths)를 제작했습니다. 이 자료들은 역학(epidemiology)의 수학을 학교에서 배우는 기초 개념부터 최첨단 연구까지 안내합니다.

> 역학의 수학은 놀랍도록 접근 가능한 동시에 깊이 있습니다. 중고등학교 수준의 지수함수와 미분방정식만으로도 감염병의 초기 확산을 이해할 수 있지만, 더 정교한 모델은 확률론, 네트워크 이론, 통계학, 편미분방정식 등 다양한 고급 수학을 동원합니다. 예를 들어, 기본 재생산 지수(basic reproduction number) $R_{0}$는 한 명의 감염자가 평균적으로 몇 명을 감염시키는지를 나타내는 핵심 지표입니다. $R_{0} > 1$이면 감염병이 확산되고, $R_{0} < 1$이면 소멸합니다. 이러한 단순한 개념이 백신 접종률 목표 설정, 사회적 거리두기 정책의 효과 예측 등 실질적인 공중보건 결정의 기초가 됩니다.
...
그리고 [두 번째 팟캐스트](https://plus.maths.org/content/living-proof-conversation-sarah-hart)에서 그녀는 자신의 경력에서 해온 많은 일들에 대해 이야기합니다: 순수수학 연구, 수학과 학과장 역임, 최초의 여성 그레샴 기하학 교수(Gresham Professor of Geometry) 그리고 영국 수학사학회(British Society for the History of Mathematics) 회장 등. 그녀는 이 모든 것들이 어떻게 하나로 통합되는지를 설명하고, 모든 연령대의 수학도들에게 조언을 전합니다.

> 그레샴 기하학 교수직은 1597년에 설립된 영국에서 가장 오래된 대학 밖 교수직 중 하나입니다. 런던의 금융가 토마스 그레샴 경(Sir Thomas Gresham)이 설립한 그레샴 칼리지는 대중에게 무료로 학문 강연을 제공하는 것을 사명으로 했습니다. 사라 하트가 427년 역사상 최초의 여성 기하학 교수가 되었다는 사실은 수학계의 성평등이 얼마나 최근의 진전인지를 보여줍니다. 이 직책의 목적은 연구 업적보다는 대중 강연과 수학의 대중화에 있으며, 이는 수학이 학계 내부만의 언어가 아니라 모든 사람이 접근하고 즐길 수 있는 문화적 자산이어야 한다는 철학을 담고 있습니다. 수학사는 단순히 과거의 기록이 아니라, 수학적 개념이 어떻게 발전하고 상호 연결되며 문화와 사회적 맥락 속에서 형성되는지를 이해하는 렌즈입니다.
